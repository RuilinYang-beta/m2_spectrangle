...
public class Bag {
	...
	private static List<Character> left = Arrays.asList('R', 'B', 'G', 'Y', 'P', 'Y', 'P', 'R', 'P', 'R', 'B', 'G', 'B',
			...
			'B', 'W');
	private static List<Character> right = Arrays.asList('R', 'B', 'G', 'Y', 'P', 'R', 'R', 'B', 'B', 'G', 'G', 'Y',
			'Y', 'P', 'P', 'R', 'R', 'B', 'B', 'G', 'G', 'Y', 'Y', 'P', 'P', 'Y', 'R', 'B', 'G', 'B', 'Y', 'Y', 'G',
			'B', 'R', 'W');
...
//	
	 ...
	 * 
	 * @ ensures old.vertical.get(i) == left.get(i) && old.left.get(i) ==
	 * vertical.get(i) && old.right.get(i) == left.get(i);
	 */
